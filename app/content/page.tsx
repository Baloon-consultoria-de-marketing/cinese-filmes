        ...
        <section data-section="section-inbound" className="flex justify-center h-screen items-center overflow-hidden bg-white">
          ...
          >
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              <Image src="/INBOUND-MARKETING-MOBILE.png" alt="Inbound Marketing" width={1080} height={1920} className="block md:hidden w-full  " quality={90} />
        ...
        <section data-section="section-endomarketing" className="flex justify-center h-screen items-center overflow-hidden bg-white">
          ...
          >
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              <Image src="/ENDOMARKETING-MOBILE.png" alt="Endomarketing" width={1920} height={1080} className="block md:hidden w-full  " quality={90} />
