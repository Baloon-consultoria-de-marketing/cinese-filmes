...
export const mockMoviesNormal: Movie[] = [
  ...
  { id: 18, title: "Tato Bistrot", brand: "De Paris", videoUrl: "3VPLprjRsIs", hasIcon: true, fullscreen: false },
  { id: 19, title: "Tato Bistrot", brand: "De Paris", videoUrl: "dUZN9-y1liI", hasIcon: true, fullscreen: false },
...
export const mockMoviesFullScreen: Movie[] = [
  { id: 2, title: "Manifesto BUNZL", brand: "EPI", videoUrl: "CktpWcoAbXU", hasIcon: true, fullscreen: true },
