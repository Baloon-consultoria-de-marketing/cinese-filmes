...
export const Footer = () => {
  return (
    <footer className="w-full flex flex-col gap-10 pt-12">
      ...
      <div className="w-full px-6 sm:px-10 md:px-16 lg:px-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-4 items-start">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="font-inter text-[22px] md:text-base text-black max-w-75">transformando histórias em conexões e resultados concretos.</p>
          </div>
          ...
          <div className="flex flex-col gap-2 ">
            ...
            <div className="font-inter text-base flex flex-col gap-1 self-start">
              <p className="whitespace-nowrap text-black">São Paulo | (11) 9 8247-7229</p>
              <p className="whitespace-nowrap text-black">Florianópolis | (11) 9 9115-1793</p>
            </div>
          </div>
