  ...
  return (
    <>
      <main className="w-full mb-4">
        {/* Seção 1 */}
        <section id="section-1" className="relative w-full aspect-video overflow-hidden">
        ...
        {/* Seção 2 */}
        <section id="section-2" className="relative w-full aspect-video overflow-hidden">
          <video className="w-full h-full object-cover" autoPlay loop muted playsInline preload="auto">
            <source src="/teste.mp4" type="video/mp4" />
          </video>
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/20 px-4">
            <div className="flex flex-col gap-2">
              ...
              <h2 className="text-white text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-center drop-shadow-lg">HISTORINHAS COLORIDAS</h2>
        ...
        {/* Seção 3 */}
        <section id="section-3" className="relative w-full aspect-video overflow-hidden">
          <video className="w-full h-full object-cover" autoPlay loop muted playsInline preload="auto">
            <source src="/teste.mp4" type="video/mp4" />
          </video>
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/20 px-4">
